...
--   ALTER WORKSPACE HOL_WORKSPACES.PUBLIC.USER_HOL_10 COMMIT;
-- to publish your change, then re-run this COPY FILES.
-- ==========================================================================

COPY FILES INTO @GOLD.SEMANTIC_MODELS/
FROM 'snow://workspace/HOL_WORKSPACES.PUBLIC.USER_HOL_10/versions/head/'
...
BEGIN
  ...
  CALL SYSTEM$CREATE_SEMANTIC_VIEW_FROM_YAML('HOL_USER_10_DB.GOLD', :yaml_str);
END;
...
BEGIN
  ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT
    ADD AGENT HOL_USER_10_DB.GOLD.CASINO_ANALYST;
...
-- 2. Select "Casino Analytics - User 10" from the agent list.
