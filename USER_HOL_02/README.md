...
# Carnival Cruise Gaming HOL -- User 02
...
| Setting | Value |
|---------|-------|
| Role | `HOL_USER_02_ROLE` |
| Warehouse | `HOL_USER_02_WH` |
| Database | `HOL_USER_02_DB` |
...
2. Open **HOL_WORKSPACES > USER_HOL_02**
...
2. Pick `HOL_USER_02_WH` as the warehouse in the notebook toolbar
...
| "Insufficient privileges" | Run `SELECT CURRENT_ROLE();` -- you should see `HOL_USER_02_ROLE`. If not, run `USE ROLE HOL_USER_02_ROLE;` |
