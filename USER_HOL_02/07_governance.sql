...
SELECT * FROM TABLE(
    INFORMATION_SCHEMA.TAG_REFERENCES('HOL_USER_02_DB.RAW_GAMING.PLAYERS', 'TABLE')
);
...
CREATE OR REPLACE MASKING POLICY EMAIL_MASK AS (val STRING) RETURNS STRING ->
    CASE
        WHEN CURRENT_ROLE() = 'HOL_USER_02_ROLE' THEN val
...
INSERT INTO RAW_GAMING.BRAND_ACCESS_CONTROL VALUES
    ('HOL_USER_02_ROLE', 'Carnival'),
    ('HOL_USER_02_ROLE', 'Holland America');
