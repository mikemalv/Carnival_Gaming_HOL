...
--   1. Navigate to Data > HOL_USER_03_DB > ANALYTICS > Stages
--   2. Click on SEMANTIC_MODELS
--   3. Click "+ Files" and upload semantic_model.yaml from your user folder
--
-- Option B (SnowSQL/CLI):
--   PUT file://./semantic_model.yaml @HOL_USER_03_DB.ANALYTICS.SEMANTIC_MODELS
...
--    - Add your semantic view: HOL_USER_03_DB.ANALYTICS.GAMING_SEMANTIC_MODEL
--
-- 4. Click "Create"
--
...
SELECT SNOWFLAKE.CORTEX.ANALYST(
    ...
    FROM_TABLE => 'HOL_USER_03_DB.ANALYTICS.GAMING_SEMANTIC_MODEL'
);
