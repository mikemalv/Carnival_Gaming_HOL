...
SELECT * FROM TABLE(
    INFORMATION_SCHEMA.TAG_REFERENCES('HOL_USER_04_DB.RAW_GAMING.PLAYERS', 'TABLE')
);
...
CREATE OR REPLACE MASKING POLICY EMAIL_MASK AS (val STRING) RETURNS STRING ->
    CASE
        WHEN CURRENT_ROLE() = 'HOL_USER_04_ROLE' THEN val
...
INSERT INTO RAW_GAMING.BRAND_ACCESS_CONTROL VALUES
    ('HOL_USER_04_ROLE', 'Carnival'),
    ('HOL_USER_04_ROLE', 'Holland America');
