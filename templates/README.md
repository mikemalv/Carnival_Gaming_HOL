...
3. **Upload the semantic model file:**
   - In Snowsight, navigate to: **Data > HOL_USER_{{USER_NUM}}_DB > GOLD > Stages > SEMANTIC_MODELS**
...
5. **Set up CoWork:**
   ...
   - Warehouse: `HOL_USER_{{USER_NUM}}_WH`
   - Add your semantic view: `HOL_USER_{{USER_NUM}}_DB.GOLD.GAMING_SEMANTIC_MODEL`
   - Click **Create**
