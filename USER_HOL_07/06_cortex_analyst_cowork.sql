...
--   1. Navigate to Data > HOL_USER_07_DB > ANALYTICS > Stages
--   2. Click on SEMANTIC_MODELS
--   3. Click "+ Files" and upload semantic_model.yaml from your user folder
--
-- Option B (SnowSQL/CLI):
--   PUT file://./semantic_model.yaml @HOL_USER_07_DB.ANALYTICS.SEMANTIC_MODELS
...
SELECT SNOWFLAKE.CORTEX.ANALYST(
    ...
    FROM_TABLE => 'HOL_USER_07_DB.ANALYTICS.GAMING_SEMANTIC_MODEL'
);
