# Carnival Cruise Gaming HOL -- User 06
...
| Setting | Value |
|---------|-------|
| Role | `HOL_USER_06_ROLE` |
| Warehouse | `HOL_USER_06_WH` |
| Database | `HOL_USER_06_DB` |
...
2. Open **HOL_WORKSPACES > USER_HOL_06**
...
3. **Upload the semantic model file:**
   - In Snowsight, navigate to: **Data > HOL_USER_06_DB > ANALYTICS > Stages > SEMANTIC_MODELS**
...
5. **Set up CoWork:**
   ...
   - Warehouse: `HOL_USER_06_WH`
   - Add your semantic view: `HOL_USER_06_DB.ANALYTICS.GAMING_SEMANTIC_MODEL`
   - Click **Create**
